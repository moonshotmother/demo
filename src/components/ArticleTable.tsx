          ...
          {sortedArticles.map((a, i) => {
            ...
            return (
              ...
              >
                ...
                <td className="px-4 py-2">{a.compositeScore?.toFixed(3) ?? "--"}</td>
                <td className="px-4 py-2">{a.CAGR.toFixed(2)}</td>
                <td className="px-4 py-2">{a.years_to_50pct_penetration.toFixed(2)}</td>
